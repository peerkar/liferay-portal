...
public class CustomFacetDisplayContextBuilderTest
	...
	public void testCustomDateRangeHasFrequency() throws Exception {
		...
		customFacetDisplayContextBuilder.setFromParameterValue(from);
		customFacetDisplayContextBuilder.setToParameterValue(to);
	...
	public void testCustomDateRangeHasTermCollectorFrequency()
		...
		customFacetDisplayContextBuilder.setFromParameterValue("2018-01-01");
		customFacetDisplayContextBuilder.setToParameterValue("2018-01-31");
	...
	public void testEmptySearchResults() throws Exception {
		...
		customFacetDisplayContextBuilder.setTotalHits(0);
	...
	public void testIsNothingSelectedWithFromAndToAttributes()
		...
		customFacetDisplayContextBuilder.setFromParameterValue("1");
		customFacetDisplayContextBuilder.setToParameterValue("100");
	...
	public void testIsNothingSelectedWithSelectedDateRange() throws Exception {
		...
		customFacetDisplayContextBuilder.setParameterValue("past-24-hours");
	...
	public void testIsRenderNothingFalseWithFromAndTo() throws Exception {
		...
		customFacetDisplayContextBuilder.setAggregationField(
	...
	public void testIsRenderNothingFalseWithHits() throws Exception {
		...
		customFacetDisplayContextBuilder.setAggregationField(
			RandomTestUtil.randomString());
		customFacetDisplayContextBuilder.setTotalHits(1);
	...
	private CustomFacetDisplayContextBuilder
		...
		customFacetDisplayContextBuilder.setFacet(facet);
		customFacetDisplayContextBuilder.setOrder("count:desc");

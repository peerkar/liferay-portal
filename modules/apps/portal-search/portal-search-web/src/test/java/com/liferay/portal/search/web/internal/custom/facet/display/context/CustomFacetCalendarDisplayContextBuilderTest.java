...
public class CustomFacetCalendarDisplayContextBuilderTest {
	...
	public void testGetRangeFromLimitAttributes() {
		...
		customFacetCalendarDisplayContextBuilder.setFrom("2018-01-31");
		customFacetCalendarDisplayContextBuilder.setTo("2018-02-28");
	...
	protected CustomFacetCalendarDisplayContextBuilder
		...
		customFacetCalendarDisplayContextBuilder.setLocale(
			LocaleUtil.getDefault());
		customFacetCalendarDisplayContextBuilder.setTimeZone(timeZone);

...
public class UpdateIndexSettingsIndexRequestExecutorImpl
	...
	protected PutIndicesSettingsRequest createPutIndicesSettingsRequest(
		...
		putIndicesSettingsRequestBuilder.index(
			ListUtil.fromArray(
		...
		if (indicesOptions != null) {
			putIndicesSettingsRequestBuilder.allowNoIndices(
				indicesOptions.isAllowNoIndices());
			putIndicesSettingsRequestBuilder.ignoreUnavailable(
				indicesOptions.isIgnoreUnavailable());
		}

		return putIndicesSettingsRequestBuilder.build();
	}

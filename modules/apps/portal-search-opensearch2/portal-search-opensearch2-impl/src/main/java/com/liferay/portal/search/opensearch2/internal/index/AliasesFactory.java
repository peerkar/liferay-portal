...
public class AliasesFactory {
	...
	public void updateConcurrentReindexingAliases(
		...
		UpdateAliasesRequest.Builder updateAliasesRequest =
		...
		_getUpdateAliasesResponse(updateAliasesRequest.build());
	}
	...
	private UpdateAliasesResponse _getUpdateAliasesResponse(
		UpdateAliasesRequest updateAliasesRequest) {

		try {
			return _openSearchIndicesClient.updateAliases(updateAliasesRequest);
		}

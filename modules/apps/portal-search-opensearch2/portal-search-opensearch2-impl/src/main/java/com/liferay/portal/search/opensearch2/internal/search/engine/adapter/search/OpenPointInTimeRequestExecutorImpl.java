...
public class OpenPointInTimeRequestExecutorImpl
	...
	protected CreatePitRequest createPitRequest(
		...
		CreatePitRequest.Builder createPitRequestBuilder =
			new CreatePitRequest.Builder();

		createPitRequestBuilder.keepAlive(
			Time.of(
				time -> time.time(
		...
		if (openPointInTimeRequest.getIndices() != null) {
			createPitRequestBuilder.targetIndexes(
				Arrays.asList(openPointInTimeRequest.getIndices()));
		}

		return createPitRequestBuilder.build();
	}

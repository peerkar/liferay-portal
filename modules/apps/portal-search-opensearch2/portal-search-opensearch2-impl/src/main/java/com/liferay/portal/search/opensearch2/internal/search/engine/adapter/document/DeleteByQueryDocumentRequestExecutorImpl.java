...
public class DeleteByQueryDocumentRequestExecutorImpl
	...
	protected DeleteByQueryRequest createDeleteByQueryRequest(
		...
		return deleteByQueryRequestBuilder.build();
	}

...
public class SearchSearchResponseAssemblerImpl
	...
	private void _addAggregations(
		...
		Map<String, Aggregate> aggregatesMap = searchResponse.aggregations();

		if (MapUtil.isEmpty(aggregatesMap)) {
			return;
		}
		...
		if (MapUtil.isEmpty(aggregationsMap)) {
			return;
		}
		...
		List<AggregationResult> aggregationResults =
			openSearchAggregationResultsTranslator.translate(aggregatesMap);

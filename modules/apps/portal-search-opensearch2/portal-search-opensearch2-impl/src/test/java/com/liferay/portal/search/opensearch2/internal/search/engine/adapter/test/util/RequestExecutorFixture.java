...
import com.liferay.portal.search.opensearch2.internal.search.engine.adapter.document.OpenSearchBulkableDocumentRequestTranslator;
import com.liferay.portal.search.opensearch2.internal.search.engine.adapter.document.OpenSearchBulkableDocumentRequestTranslatorImpl;
...
public class RequestExecutorFixture {
	...
	public void setUp() {
		...
		ReflectionTestUtil.setFieldValue(
			_createIndexRequestExecutor, "_openSearchConnectionManager",
			_openSearchConnectionManager);

		_deleteIndexRequestExecutor = new DeleteIndexRequestExecutorImpl();

		ReflectionTestUtil.setFieldValue(
			_deleteIndexRequestExecutor, "_openSearchConnectionManager",
			_openSearchConnectionManager);
		...
		ReflectionTestUtil.setFieldValue(
			_getDocumentRequestExecutor, "_openSearchConnectionManager",
			_openSearchConnectionManager);
		ReflectionTestUtil.setFieldValue(
		...
		ReflectionTestUtil.setFieldValue(
			...
			openSearchBulkableDocumentRequestTranslator);
		ReflectionTestUtil.setFieldValue(
			_indexDocumentRequestExecutor, "_openSearchConnectionManager",
			_openSearchConnectionManager);
		...
		ReflectionTestUtil.setFieldValue(
			...
			openSearchBulkableDocumentRequestTranslator);
		ReflectionTestUtil.setFieldValue(
			_updateDocumentRequestExecutor, "_openSearchConnectionManager",
			_openSearchConnectionManager);
	}

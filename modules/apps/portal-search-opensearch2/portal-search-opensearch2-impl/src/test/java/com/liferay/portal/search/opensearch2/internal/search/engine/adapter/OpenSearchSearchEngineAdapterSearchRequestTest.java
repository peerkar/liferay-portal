...
public class OpenSearchSearchEngineAdapterSearchRequestTest {
	...
	public static void setUpClass() throws Exception {
		...
		_openSearchFixture = new OpenSearchFixture(
			OpenSearchSearchEngineAdapterSearchRequestTest.class);
	...
	private void _putMapping(String mappingSource) throws JSONException {
		...
		putMappingRequestBuilder.dynamicTemplates(

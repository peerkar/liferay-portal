...
import fi.soveltia.liferay.gsearch.elasticsearch.query.GSearchDecayFunctionScoreQueryTranslator;
...
import com.liferay.portal.search.elasticsearch6.internal.query.CombineFunctionTranslator;
import com.liferay.portal.search.elasticsearch6.internal.query.FunctionScoreQueryTranslator;
...
@Component(
	...
	service = FunctionScoreQueryTranslator.class
)
public class GSearchFunctionScoreQueryTranslatorImpl implements FunctionScoreQueryTranslator {
	...
	public QueryBuilder translate(
		...
		if (functionScoreQuery instanceof GSearchDecayFunctionScoreQuery) {
			
			return _decayFunctionScoreQueryTranslator.translate(
					(GSearchDecayFunctionScoreQuery) functionScoreQuery);
			
		} else if (functionScoreQuery instanceof GSearchFieldValueFactorFunctionScoreQuery) {
	
			return _fieldValueFactorFunctionScoreQueryTranslator.translate(
	...
	@Reference
	private GSearchDecayFunctionScoreQueryTranslator _decayFunctionScoreQueryTranslator;

	@Reference
	private GSearchFieldValueFactorFunctionScoreQueryTranslator _fieldValueFactorFunctionScoreQueryTranslator;

...
/**
 * Liferay GSearch MatchQuery translator impl.
 * 
 * Adds the boost option, missing in the default translator.
 * 
...
@Component(
	...
	service = MatchQueryTranslator.class
)
public class GSearchMatchQueryTranslatorImpl 

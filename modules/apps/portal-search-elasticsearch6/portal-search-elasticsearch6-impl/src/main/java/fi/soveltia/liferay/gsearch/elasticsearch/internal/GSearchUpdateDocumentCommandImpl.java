...
@Component(
		immediate = true,
		service = GSearchUpdateDocumentCommand.class
)
public class GSearchUpdateDocumentCommandImpl
	implements GSearchUpdateDocumentCommand {
				...
				if (deleteFirst) {
					DeleteRequestBuilder deleteRequestBuilder =
						client.prepareDelete(
								GSearchIndexUtil.getQuerySuggestionIndexName(searchContext.getCompanyId()),
								GSearchIndexUtil.getQuerySuggestionType(), document.getUID());
	...
	private static final Log _log = LogFactoryUtil.getLog(
		GSearchUpdateDocumentCommandImpl.class);

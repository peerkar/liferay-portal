...
public class AssetListEntrySegmentsEntryRelLocalServiceImpl
	...
	public AssetListEntrySegmentsEntryRel addAssetListEntrySegmentsEntryRel(
		...
		assetListEntrySegmentsEntryRel.setCreateDate(serviceContext.getCreateDate(new Date()));
		assetListEntrySegmentsEntryRel.setModifiedDate(serviceContext.getModifiedDate(new Date()));

...
public class ImportProcessRequest implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The external reference codes of the sites to import, picked from the sites the LAR carries. Sites the LAR carries that are not listed here are skipped. Only honored at instance level."
	)
...
// LIFERAY-REST-BUILDER-HASH:-1256488820
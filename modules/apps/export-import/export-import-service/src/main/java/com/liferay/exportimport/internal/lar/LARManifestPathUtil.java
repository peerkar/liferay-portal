 ...
 *
 * <p>
 * Whether a pass is a per-site pass is answered by {@link
 * SiteExportImportParameterUtil#isSitePass}, from a parameter written once when
 * the per-site context is created and never mutated afterwards.
 * </p>
 *

 ...
 * @author Kevin Tan
 */
@Component(immediate = true, service = SXPBlueprintExceptionRequestHandler.class)
public class SXPBlueprintExceptionRequestHandler {
	...
	public void handlePortalException(
		...
		if (portalException instanceof SXPBlueprintConfigurationsJSONException) {
			SXPBlueprintConfigurationsJSONException sxpBlueprintConfigurationsJSONException =
				(SXPBlueprintConfigurationsJSONException)portalException;

			_addProblems(
				jsonArray, sxpBlueprintConfigurationsJSONException.getProblems(),
				themeDisplay);
		}
		else if (portalException instanceof SXPElementElementDefinitionJSONException) {
			SXPElementElementDefinitionJSONException sxpElementElementDefinitionJSONException =
				(SXPElementElementDefinitionJSONException)portalException;

			_addProblems(
				jsonArray, sxpElementElementDefinitionJSONException.getProblems(),
				themeDisplay);
		}

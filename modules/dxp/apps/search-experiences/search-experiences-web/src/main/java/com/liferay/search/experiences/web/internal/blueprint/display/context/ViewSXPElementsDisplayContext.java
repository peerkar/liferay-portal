...
import com.liferay.search.experiences.web.internal.blueprint.security.permission.resource.SXPElementEntryPermission;
...
public class ViewSXPElementsDisplayContext
	...
	public SearchContainer<SXPElement> getSearchContainer()
		...
		SearchContainer<SXPElement> searchContainer = super.getSearchContainer();

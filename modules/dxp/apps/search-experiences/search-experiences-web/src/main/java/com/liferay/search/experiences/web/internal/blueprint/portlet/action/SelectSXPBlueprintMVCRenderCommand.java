...
@Component(
	...
	property = {
		...
		"mvc.command.name=" + SXPBlueprintMVCCommandNames.SELECT_SXP_BLUEPRINT
	},
	service = MVCRenderCommand.class
)
public class SelectSXPBlueprintMVCRenderCommand implements MVCRenderCommand {

	@Override
	public String render(
		RenderRequest renderRequest, RenderResponse renderResponse) {

		return "/select_sxp_blueprint.jsp";
	}

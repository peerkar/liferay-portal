...
package com.liferay.search.experiences.sxpBlueprints.result.web.internal.hit.contributor;
...
import com.liferay.search.experiences.sxpBlueprints.result.web.internal.constants.ResultWebPortletKeys;
import com.liferay.search.experiences.sxpBlueprints.result.web.internal.util.ResultUtil;
...
public class ViewURLHitContributor implements HitContributor {
	...
	// TODO: If JSON translation API drops, this is not needed
	
	@Override
	public void contribute(
		JSONObject hitJSONObject, Document document,
		ResultBuilder resultBuilder, BlueprintsAttributes sxpBlueprintsAttributes,
		ResourceBundle resourceBundle) {

		PortletRequest portletRequest = _getPortletRequest(
			sxpBlueprintsAttributes);
		...
		hitJSONObject.put(
			...
			getViewURL(
				...
				_isViewInContext(sxpBlueprintsAttributes)));
	}
	...
	private PortletRequest _getPortletRequest(
			BlueprintsAttributes sxpBlueprintsAttributes)
		throws ClassCastException {

		Optional<Object> portletRequestOptional =
			sxpBlueprintsAttributes.getAttributeOptional(

...
public class ImportSXPBlueprintMVCActionCommand extends BaseMVCActionCommand {
	...
	private void _import(
		...
		catch (SXPBlueprintConfigurationsJSONException sxpBlueprintConfigurationsJSONException) {
			_log.error(
					sxpBlueprintConfigurationsJSONException.getMessage(),
					sxpBlueprintConfigurationsJSONException);
			_logValidationMessages(sxpBlueprintConfigurationsJSONException.getProblems());

			_sxpBlueprintExceptionRequestHandler.handlePortalException(
				actionRequest, actionResponse, sxpBlueprintConfigurationsJSONException);
		}
		...
		catch (SXPElementElementDefinitionJSONException sxpElementDefinitionJSONException) {
			_log.error(
					sxpElementDefinitionJSONException.getMessage(),
					sxpElementDefinitionJSONException);
			_logValidationMessages(sxpElementDefinitionJSONException.getProblems());

			_sxpBlueprintExceptionRequestHandler.handlePortalException(
				actionRequest, actionResponse, sxpElementDefinitionJSONException);
		}
	...
	@Reference
	private SXPBlueprintExceptionRequestHandler _sxpBlueprintExceptionRequestHandler;

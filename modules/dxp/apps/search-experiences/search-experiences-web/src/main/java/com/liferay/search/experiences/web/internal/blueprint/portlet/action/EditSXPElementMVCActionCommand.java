...
public class EditSXPElementMVCActionCommand extends BaseMVCActionCommand {
	...
	protected void doProcessAction(
		...
		String elementDefinitionJSON = SXPBlueprintRequestUtil.getElementDefinitionJSON(
			actionRequest);
		...
		try {
			...
			if (Constants.ADD.equals(cmd)) {
				...
				jsonObject = JSONUtil.put(
					"redirectURL",
					_getRedirectURL(
						actionRequest, actionResponse, sxpElement.getSXPElementId()));
				...
				for (long sxpElementId : hideConfigurationIds) {
					SXPElement sxpElement = _sxpElementService.getSXPElement(sxpElementId);
	...
	private long[] _getElementIds(ActionRequest actionRequest) {
		...
		long sxpElementId = SXPBlueprintRequestUtil.getSXPElementId(actionRequest);

...
public class EditSXPBlueprintMVCActionCommand extends BaseMVCActionCommand {
	...
	protected void doProcessAction(
		...
		String configurationsJSON = SXPBlueprintRequestUtil.getConfigurationsJSON(
			actionRequest);
		...
		try {
			...
			if (Constants.ADD.equals(cmd)) {
				SXPBlueprint sxpBlueprint = _sxpSXPBlueprintService.addSXPBlueprint(
	...
	private ServiceContext _createServiceContext(ActionRequest actionRequest)
		...
		serviceContext.setAttribute("skip.sxpblueprint.validation", Boolean.TRUE);

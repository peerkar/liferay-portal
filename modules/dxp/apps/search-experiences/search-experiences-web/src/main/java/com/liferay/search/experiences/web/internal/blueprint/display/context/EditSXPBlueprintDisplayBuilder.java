...
public class EditSXPBlueprintDisplayBuilder extends EditEntryDisplayBuilder {
	...
	public EditSXPBlueprintDisplayBuilder(
		...
		_sxpBlueprintId = SXPBlueprintRequestUtil.getSXPBlueprintId(renderRequest);
	}
	...
	private Map<String, Object> _getProps() {
		...
		if (_sxpBlueprint != null) {
			props.put(
				"initialConfigurationString", _sxpBlueprint.getConfigurationsJSON());
			props.put(
				"initialDescription",
			...
			props.put(
				"initialTitle", getTitleJSONObject(_sxpBlueprint.getTitleMap()));
		}
	...
	private JSONArray _getQueryElementsJSONArray() {
		...
		List<SXPElement> queryElements = sxpElementService.getGroupElements(
			themeDisplay.getCompanyGroupId(), SXPElementTypes.QUERY_SXP_ELEMENT, 0,
			sxpBlueprintsTotalCount);

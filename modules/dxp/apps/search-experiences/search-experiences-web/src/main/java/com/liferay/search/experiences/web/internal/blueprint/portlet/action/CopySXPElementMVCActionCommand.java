	...
	private void _createCopy(
		...
		try {
			...
			_sxpElementService.addSXPElement(
				...
				sourceElement.getElementDefinitionJSON(),		
				false,
				_getTitleMap(sourceElement),
				sourceElement.getType(),
				serviceContext);

			sendRedirect(actionRequest, actionResponse);
		}
		catch (SXPElementElementDefinitionJSONException sxpElementElementDefinitionJSONException) {
			_log.error(

...
package com.liferay.search.experiences.web.internal.options.portlet.preferences;

import com.liferay.petra.string.StringPool;
import com.liferay.search.experiences.web.internal.options.util.PortletPreferencesHelper;
...
public class SXPBlueprintOptionsPortletPreferencesImpl
	...
	public Optional<String> getSXPBlueprintIdOptional() {
		return _portletPreferencesHelper.getString(
			SXPBlueprintOptionsPortletPreferences.PREFERENCE_KEY_SXP_BLUEPRINT_ID);
	}

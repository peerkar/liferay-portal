...
public class SXPBlueprintRequestUtil {
	...
	public static String getElementDefinitionJSON(PortletRequest portletRequest) {
		return ParamUtil.getString(
	...
	public static boolean getHidden(PortletRequest portletRequest) {
		return ParamUtil.getBoolean(
			portletRequest, SXPBlueprintWebKeys.HIDDEN);
	}
	...
	public static String getElementInstancesJSON(PortletRequest portletRequest) {
		return ParamUtil.getString(
	...
	public static Optional<SXPBlueprint> getSXPBlueprint(
		...
		try {
			return Optional.of(_sxpSXPBlueprintService.getSXPBlueprint(sxpBlueprintId));
		}
	...
	public static Optional<SXPElement> getSXPElement(
		...
		try {
			...
			_log.error(
				"SXPElement " + sxpElementId + " not found", noSuchElementException);

...
public class ExportSXPBlueprintMVCResourceCommand extends BaseMVCResourceCommand {
	...
	protected void doServeResource(
		...
		Optional<SXPBlueprint> optional = SXPBlueprintRequestUtil.getSXPBlueprint(
	...
	private String _buildResponseString(SXPBlueprint sxpBlueprint) throws Exception {
		return JSONUtil.put(
			"sxp-blueprint-payload",
			JSONUtil.put(
				"configurationsJSON",
				_jsonFactory.createJSONObject(sxpBlueprint.getConfigurationsJSON())
			).put(
				"description",
				...
				_jsonFactory.createJSONObject(sxpBlueprint.getElementInstancesJSON())
			).put(
				"title",
				SXPBlueprintExportUtil.mapToJSONObject(

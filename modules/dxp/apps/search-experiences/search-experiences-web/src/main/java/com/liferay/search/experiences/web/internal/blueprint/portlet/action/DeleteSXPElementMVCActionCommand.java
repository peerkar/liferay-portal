...
import com.liferay.search.experiences.exception.DefaultSXPElementEntryException;
...
public class DeleteSXPElementMVCActionCommand extends BaseMVCActionCommand {
	...
	private void _delete(ActionRequest actionRequest) {
		...
		try {
			...
			if (portalException instanceof DefaultSXPElementEntryException) {
				if (_log.isDebugEnabled()) {
					_log.debug(portalException.getMessage(), portalException);
				}

				SessionErrors.add(
					actionRequest, DefaultSXPElementEntryException.class);

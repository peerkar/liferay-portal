...
import com.liferay.search.experiences.sxpBlueprints.Blueprint;
...
import com.liferay.search.experiences.sxpBlueprints.engine.exception.BlueprintsEngineException;
...
import com.liferay.search.experiences.sxpBlueprints.exception.BlueprintValidationException;
...
public class PreviewSXPBlueprintMVCResourceCommand extends BaseMVCResourceCommand {
	...
	protected String getResponseJSONString(
		...
		try {
			...
			SearchResponse searchResponse = _sxpBlueprintsEngineHelper.search(
				sxpBlueprint, requestBlueprintsAttributes, problemsHolderBuilder);
		...
		catch (SXPBlueprintValidationException sxpBlueprintValidationException) {
	...
	private BlueprintsAttributes _getRequestBlueprintsAttributes(
		...
		BlueprintsAttributesBuilder sxpBlueprintsAttributesBuilder =
			_sxpBlueprintsAttributesHelper.getBlueprintsRequestAttributesBuilder(
	...
	private BlueprintsAttributes _getResponseBlueprintsAttributes(
		ResourceRequest resourceRequest, ResourceResponse resourceResponse,
		SXPBlueprint sxpBlueprint, BlueprintsAttributes requestBlueprintsAttributes) {

		BlueprintsAttributesBuilder sxpBlueprintsAttributesBuilder =
			_sxpBlueprintsAttributesHelper.getBlueprintsResponseAttributesBuilder(
				resourceRequest, resourceResponse, sxpBlueprint,
				requestBlueprintsAttributes);

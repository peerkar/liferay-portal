...
<%
	SelectSXPBlueprintDisplayContext selectBlueprintDisplayContext = new SelectSXPBlueprintDisplayContext(liferayPortletRequest, liferayPortletResponse);
%>

<clay:management-toolbar
	displayContext="<%=new SelectSXPBlueprintManagementToolbarDisplayContext(liferayPortletRequest, liferayPortletResponse, selectBlueprintDisplayContext.getSearchContainer())%>"
/>

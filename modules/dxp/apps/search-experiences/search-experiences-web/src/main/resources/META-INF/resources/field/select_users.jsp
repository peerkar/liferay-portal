...
<%
	SelectUsersDisplayContext selectUsersDisplayContext = (SelectUsersDisplayContext)request.getAttribute(SXPBlueprintWebKeys.SELECT_USERS_DISPLAY_CONTEXT);
%>

<clay:management-toolbar
	managementToolbarDisplayContext="<%=(SelectUsersManagementToolbarDisplayContext)request.getAttribute(SXPBlueprintWebKeys.SELECT_USERS_MANAGEMENT_TOOLBAR_DISPLAY_CONTEXT)%>"
/>

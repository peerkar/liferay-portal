...
<%
	ViewSXPElementsDisplayContext viewElementsDisplayContext = (ViewSXPElementsDisplayContext)request.getAttribute(SXPBlueprintWebKeys.VIEW_SXP_ELEMENTS_DISPLAY_CONTEXT);
%>

<portlet:actionURL name="<%=SXPBlueprintMVCCommandNames.DELETE_ELEMENT%>" var="deleteElementURL">
	<portlet:param name="redirect" value="<%=currentURL%>" />
</portlet:actionURL>

<portlet:actionURL name="<%=SXPBlueprintMVCCommandNames.EDIT_ELEMENT%>" var="hideElementURL">
	<portlet:param name="redirect" value="<%=currentURL%>" />
	<portlet:param name="<%=Constants.CMD%>" value="<%=SXPBlueprintWebKeys.HIDE%>" />
	<portlet:param name="hidden" value="<%=Boolean.TRUE.toString()%>" />
</portlet:actionURL>

<portlet:actionURL name="<%=SXPBlueprintMVCCommandNames.EDIT_ELEMENT%>" var="showElementURL">
	<portlet:param name="redirect" value="<%=currentURL%>" />
	<portlet:param name="<%=Constants.CMD%>" value="<%=SXPBlueprintWebKeys.HIDE%>" />

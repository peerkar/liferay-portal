...
<%
	SXPBlueprintOptionsPortletPreferences blueprintsOptionsPortletPreferences = new SXPBlueprintOptionsPortletPreferencesImpl(java.util.Optional.ofNullable(portletPreferences));
%>
...
>
	...
	<aui:input name="<%=PortletPreferencesJspUtil.getInputName(SXPBlueprintOptionsPortletPreferences.PREFERENCE_KEY_BLUEPRINT_ID)%>" type="hidden" value="<%=blueprintsOptionsPortletPreferences.getSXPBlueprintIdString()%>" />
	...
	<liferay-frontend:edit-form-body>
		<liferay-frontend:fieldset-group>
			<liferay-frontend:fieldset>
				...
				<aui:input helpMessage="federated-search-key-help" label="federated-search-key" name="<%=PortletPreferencesJspUtil.getInputName(SXPBlueprintOptionsPortletPreferences.PREFERENCE_KEY_FEDERATED_SEARCH_KEY)%>" type="text" value="<%= blueprintsOptionsPortletPreferences.getFederatedSearchKeyString() %>" />
			</liferay-frontend:fieldset>
		</liferay-frontend:fieldset-group>
	</liferay-frontend:edit-form-body>

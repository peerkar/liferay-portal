...
<%@ include file="/result/init.jsp" %>

<%
	portletDisplay.setShowBackIcon(false);

ResultContentDisplayBuilder blueprintsContentDisplayBuilder = new ResultContentDisplayBuilder();
...
ResultContentDisplayContext blueprintsContentDisplayContext = blueprintsContentDisplayBuilder.build();
%>

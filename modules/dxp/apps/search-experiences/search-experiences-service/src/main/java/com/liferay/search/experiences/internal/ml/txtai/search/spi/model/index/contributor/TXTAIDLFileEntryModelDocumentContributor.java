...
@Component(
	...
	property = "indexer.class.name=om.liferay.document.library.kernel.model.DLFileEntry",
	service = ModelDocumentContributor.class
)
public class TXTAIDLFileEntryModelDocumentContributor
	...
	public void contribute(Document document, DLFileEntry dlFileEntry) {
		if (!isAddTextEmbeddings(DLFileEntry.class, _txtAIConfiguration)) {
			return;
		}

		addTextEmbedding(
			document, document.get(Field.CONTENT), _txtAIConfiguration);
	}

...
import com.liferay.search.experiences.blueprint.clause.ClauseTranslator;
...
public class ClauseHelper {
	...
	public Optional<Query> getQueryOptional(
		...
		try {
			...
			return clauseTranslator.translate(optional.get(), sxpParameterData);
		}
		catch (IllegalArgumentException illegalArgumentException) {
			_log.error(illegalArgumentException);

			ProblemUtil.addInvalidConfigurationValueError(
				getClass().getName(), jsonObject, null, type,
	...
	private Optional<JSONObject> _getParsedClause(
		...
		return _sxpBlueprintTemplateVariableParser.parseObject(
